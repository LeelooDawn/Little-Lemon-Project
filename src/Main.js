    ...
    <main class="main-container">
      <div class="cards">
        ...
        <article class="card">
          ...
          <div class="content">
            <p>
              Our Bruchetta is a great addition to any dish or salad. Topped
              with fresh tomatoes
            </p>
          </div>
          <footer>Order Online!</footer>
      ...
      <div class="testimonials">
        ...
        <div class="reviews">
          <h3>5 stars</h3>
          <p>
            "I love Little Lemon. Especially their Bruchetta, its great! - Tracy{" "}
          </p>
        </div>
        <div class="reviews">
          <h3>5 stars</h3>
        ...
        <div class="reviews">
          <h3>5 stars</h3>
          <p>
            "Little Lemon is a great weekend night out. They have live music on
            Fridays!{" "}
          </p>
        </div>
      </div>
